...
mixin _$ProductDetailsState {
  ...
  TResult map<TResult extends Object?>({
    ...
    required TResult Function(_Products value) product,
  ...
  TResult? mapOrNull<TResult extends Object?>({
    ...
    TResult Function(_Products value)? product,
...
class _$_Products implements _Products {
  const _$_Products(this.product);
  ...
  @override
  String toString() {
    return 'ProductDetailsState.product(product: $product)';
  }
...
abstract class _Products implements ProductDetailsState {
  const factory _Products(Product product) = _$_Products;
...
class _$_Failed implements _Failed {
  ...
  @override
  String toString() {
    return 'ProductDetailsState.failed(failure: $failure)';
  }
...
abstract class _Failed implements ProductDetailsState {
