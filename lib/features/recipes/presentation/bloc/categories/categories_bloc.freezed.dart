...
class _$CategoriesStateTearOff {
  ...
  _Categories categories(List<Category> categories) {
    return _Categories(
      categories,
    );
  }
...
/// @nodoc
class __$LoadingCopyWithImpl<$Res> extends _$CategoriesStateCopyWithImpl<$Res>
...
class _$_Categories implements _Categories {
  const _$_Categories(this.categories);
  ...
  @override
  String toString() {
    return 'CategoriesState.categories(categories: $categories)';
  }
...
abstract class _Categories implements CategoriesState {
  const factory _Categories(List<Category> categories) = _$_Categories;
...
class _$_Failed implements _Failed {
  ...
  @override
  String toString() {
    return 'CategoriesState.failed(failure: $failure)';
  }
